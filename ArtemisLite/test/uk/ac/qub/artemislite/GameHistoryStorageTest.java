...
class GameHistoryStorageTest {
	...
	void testAddAndDisplayMoveHistory() {
		...
		String expectedResult = "On move 1, player1 landed on element 3 and developed portfolio\n"
				+ "On move 2, player2 landed on element 8 and developed this element\n"
				+ "On move 3, player3 landed on element 4 and forfeit resources\n"
				+ "On move 4, player4 landed on element 7 and purchased this element\n";
